    ...
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <div className='flex items-center gap-6'>
            ...
            <Link className='relative' to='/cart'>
                ...
                <p className='absolute -right-2 -bottom-2 flex h-5 w-5 items-center justify-center rounded-full bg-black text-[10px] text-white'>10</p>
            </Link>
        ...
        <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
            <div className='flex flex-col text-gray-600'>
                ...
                <NavLink onClick={() => setVisible(false)} className='py-4 pl-8  border' to='/'>HOME</NavLink>
